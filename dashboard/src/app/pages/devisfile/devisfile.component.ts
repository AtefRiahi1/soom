...
@Component({
  selector: 'app-devisfile',
  templateUrl: './devisfile.component.html',
  styleUrls: ['./devisfile.component.scss']
})
export class DevisfileComponent {
  ...
  blobUrl: SafeResourceUrl | null = null;
      ...
      constructor(private router: Router,private sanitizer: DomSanitizer, private actR: ActivatedRoute, private orderservice: DevisService,private entrepriseService: EntrepriseService,
    ...
    download(user:any){
      this.orderservice.getDevisById(this.ido).subscribe((data:any)=>{
