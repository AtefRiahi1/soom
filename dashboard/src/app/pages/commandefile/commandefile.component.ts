...
@Component({
  selector: 'app-commandefile',
  templateUrl: './commandefile.component.html',
  styleUrls: ['./commandefile.component.scss']
})
export class CommandefileComponent {
  ...
  blobUrl: SafeResourceUrl | null = null;
        ...
        constructor(private router: Router,private sanitizer: DomSanitizer, private actR: ActivatedRoute, private orderservice: CommandeService,private entrepriseService: EntrepriseService,
      ...
      download(user:any){
        this.orderservice.getCommandeById(this.ido).subscribe((data:any)=>{
