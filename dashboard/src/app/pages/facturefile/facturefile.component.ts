...
@Component({
  selector: 'app-facturefile',
  templateUrl: './facturefile.component.html',
  styleUrls: ['./facturefile.component.scss']
})
export class FacturefileComponent {
  ...
  blobUrl: SafeResourceUrl | null = null;
            ...
            constructor(private router: Router,private sanitizer: DomSanitizer, private actR: ActivatedRoute, private orderservice: FactureService,private entrepriseService: EntrepriseService,
          ...
          download(user:any){
            this.orderservice.getFactureById(this.ido).subscribe((data:any)=>{
