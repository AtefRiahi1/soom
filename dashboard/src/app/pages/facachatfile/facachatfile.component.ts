...
@Component({
  selector: 'app-facachatfile',
  templateUrl: './facachatfile.component.html',
  styleUrls: ['./facachatfile.component.scss']
})
export class FacachatfileComponent {
  ...
  blobUrl: SafeResourceUrl | null = null;
    ...
    constructor(private router: Router,private sanitizer: DomSanitizer, private actR: ActivatedRoute, private orderservice: FactureAchatService,private entrepriseService: EntrepriseService,
  ...
  download(user:any){
    this.orderservice.getFactureAchatById(this.ido).subscribe((data:any)=>{
