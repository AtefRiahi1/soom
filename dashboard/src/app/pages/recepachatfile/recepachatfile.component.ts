...
@Component({
  selector: 'app-recepachatfile',
  templateUrl: './recepachatfile.component.html',
  styleUrls: ['./recepachatfile.component.scss']
})
export class RecepachatfileComponent {
  blobUrl: SafeResourceUrl | null = null;
      ...
      constructor(private router: Router,private sanitizer: DomSanitizer, private actR: ActivatedRoute, private orderservice: ReceptionAchatService,private entrepriseService: EntrepriseService,
    ...
    download(user:any){
      this.orderservice.getReceptionAchatById(this.ido).subscribe((data:any)=>{
