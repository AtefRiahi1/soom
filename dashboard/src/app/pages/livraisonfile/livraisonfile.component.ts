...
@Component({
  selector: 'app-livraisonfile',
  templateUrl: './livraisonfile.component.html',
  styleUrls: ['./livraisonfile.component.scss']
})
export class LivraisonfileComponent {
  ...
  blobUrl: SafeResourceUrl | null = null;
          ...
          constructor(private router: Router,private sanitizer: DomSanitizer, private actR: ActivatedRoute, private orderservice: LivraisonService,private entrepriseService: EntrepriseService,
        ...
        download(user:any){
          this.orderservice.getLivraisonById(this.ido).subscribe((data:any)=>{
