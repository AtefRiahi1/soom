...
@Component({
  ...
  templateUrl: './sortiefile.component.html',
  styleUrls: ['./sortiefile.component.scss']
})
export class SortiefileComponent {
  ...
  blobUrl: SafeResourceUrl | null = null;
              ...
              constructor(private router: Router,private sanitizer: DomSanitizer, private actR: ActivatedRoute, private orderservice: SortieService,private entrepriseService: EntrepriseService,
            ...
            download(user:any){
              this.orderservice.getSortieById(this.ido).subscribe((data:any)=>{
